...
function facturaFechasOrden($db) {
    if (!isset($_POST) || empty($_POST)) {
        ...
        while ($fecha1 <= $fecha2) {
            ...
            if ($sql1) {
                ...
                $sql2 = mysqli_query($db, "SELECT INVOICELINEID, TRACKID, UNITPRICE FROM INVOICELINE WHERE INVOICEID='$idFactura' ORDER BY QUANTITY ASC");
                if ($sql2) {
